...
?>
  ...
  <head>
    ...
    <title>Add Author – Online Book Store</title>
    ...
    <style>
      ...
      * {
      ...
      .add-author-form {
        ...
        width: 100%;
        max-width: 500px;
        /* Consistent max-width with add-category */
        color: #f0f0f0;
        /* Text color for the form */
      }

      .add-author-form .form-label {
        color: #ddd;
        font-weight: 500;
      }

      .add-author-form .form-control {
      ...
      .add-author-form .form-control::placeholder {
        color: rgba(255, 255, 255, 0.7);
      }

      .add-author-form .form-control:focus {
        background: rgba(255, 255, 255, 0.1);
      ...
      .add-author-form .btn-primary:hover {
  ...
  <body>
    ...
    <div class="container d-flex flex-column align-items-center">
      <form action="php/add-author.php" method="post" class="add-author-form">
        <h1 class="text-center mb-4 text-light">Add New Author</h1>

        <div class="mb-3">
          <label class="form-label">Author Name</label>
          <input type="text" class="form-control" name="author_name" autocomplete="off">
        </div>
