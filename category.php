...
<head>
    ...
    <title><?= htmlspecialchars($current_category['name']) ?> – Online Book Store</title>
    ...
    <div class="filters">
        <select class="form-select" onchange="if(this.value) window.location.href=this.value">
            ...
            <?php foreach ($categories as $category) { ?>
                <option value="category.php?id=<?= $category['id'] ?>" <?= ($category['id'] == $id) ? 'selected' : '' ?>>
                ...
                ?>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-text">
                                <b>By:</b> <?= htmlspecialchars($author) ?><br>
                                <b>Category:</b> <?= htmlspecialchars($current_category['name']) ?>
                            </div>
                        </div>
