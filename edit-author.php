...
if ($author == 0) { // Check if author was actually found
    header("Location: admin.php");
    exit;
}
?>
...
<head>
    ...
    <title>Edit Author – Online Book Store</title>
    ...
    <style>
        ...
        * {
        ...
        .edit-author-form { /* Changed class name for clarity */
        ...
        .edit-author-form .form-label {
            color: #ddd;
            font-weight: 500;
        }

        .edit-author-form .form-control {
        ...
        .edit-author-form .form-control::placeholder {
            color: rgba(255, 255, 255, 0.7);
        }

        .edit-author-form .form-control:focus {
        ...
        .edit-author-form .btn-primary:hover {
            background-color: #e6b800;
            transform: translateY(-2px);
        }

        .edit-author-form .btn-outline-secondary {
            color: #ddd;
            border-color: #ddd;
        ...
        .edit-author-form .btn-outline-secondary:hover {
...
<body>
    ...
    <div class="container d-flex flex-column align-items-center">
                <form action="php/edit-author.php" method="post" class="edit-author-form">
                        <a href="admin.php" class="btn btn-outline-secondary">
                <i class="fas fa-arrow-left"></i> Back
            </a>
            <h1 class="text-center mb-4 text-light">Edit Author</h1>

            <?php
            $old_name = $_SESSION['old_name'] ?? $author['name'];
            unset($_SESSION['old_name']);
            ?>

                        <div class="mb-3">
                <label class="form-label">Author Name</label>
                <input type="text" class="form-control" name="author_name" autocomplete="off" value="<?= htmlspecialchars($old_name) ?>">
                <input type="hidden" name="author_id" value="<?= htmlspecialchars($author['id']) ?>">
            </div>
